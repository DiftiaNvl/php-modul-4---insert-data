...
if($_POST){
    ...
    if(empty($id_petugas)){
        ...
        if($insert){
            ...
            echo "<script>alert('Sukses membuat akun');location.href='tambah_petugas.php';</script>";

        } else {

            echo "<script>alert('Gagal membuat akun');location.href='tambah_petugas.php';</script>";
